...
The core queue operations remain recognizable, but current delivery, DLQ retention, namespace migration, and browser-store behavior are documented in the [queue reference](./skills/sync/references/queue.md).
